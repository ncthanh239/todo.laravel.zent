		...
		<div class="wrapper_top_w3layouts">
			<div class="header_agileits">
				<div class="logo inner_page_log">
					<h1><a class="navbar-brand" href="{{asset('')}}"><span>Ncthanh</span> <i>Shop</i></a></h1>
				</div>
				<div class="overlay overlay-contentpush">
					...
					<nav>
						<ul>
							...
							<li><a href="{{asset('')}}login" class="active">Acount</a>
		...
		<div class="services-breadcrumb_w3ls_agileinfo">
			<div class="inner_breadcrumb_agileits_w3">
				...
				<ul class="short">
					...
					@endif
					@if (Auth::user()!==null)
					<li>Shop &nbsp; | &nbsp; <a href="{{asset('')}}detail">{{Auth::user()->name}}</a> </li>
					@endif
				</ul>
			</div>
		</div>
							...
							<div class="product-shoe-info shoe">
								<div class="men-pro-item">
									<div class="men-thumb-item">
										<img src="{{asset(\Storage::url($value['image']->first()['link_image']))}}" style="width: 100%; height: 100%;">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="{{asset('')}}single/{{$value['id']}}" class="link-product-add-cart">Quick View</a>
											</div>
										</div>
									...
									<div class="item-info-product">
										<h4>
											<a href="{{asset('')}}single/{{$value['id']}}">{{$value['name']}} </a>
										</h4>
